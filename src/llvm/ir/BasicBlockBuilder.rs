...
target triple = "x86_64-pc-linux-musl"
...
define void @looper2(%struct.Subscribers* noalias nocapture nonnull readonly) local_unnamed_addr #0 {
  ...
  %3 = load %struct.Subscriber*, %struct.Subscriber** %2, align 8, !tbaa !1
  %4 = getelementptr inbounds %struct.Subscriber, %struct.Subscriber* %3, i64 1000
  %5 = bitcast %struct.Subscriber* %4 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %5, i8* bitcast (%struct.Subscriber* @looper2.subscriber1 to i8*), i64 16, i32 8, i1 false), !tbaa.struct !7
  ret void
}
