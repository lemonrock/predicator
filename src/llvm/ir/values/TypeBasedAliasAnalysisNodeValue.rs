...
pub struct TypeBasedAliasAnalysisNodeValue(LLVMValueRefWrapper);

impl Value for TypeBasedAliasAnalysisNodeValue
{
	#[inline(always)]
	fn fromLLVMValueRef(value: LLVMValueRef) -> Self
	{
		TypeBasedAliasAnalysisNodeValue(LLVMValueRefWrapper::fromLLVMValueRef(value))
	}
